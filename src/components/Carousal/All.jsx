...
function All() {
    ...
    const movenext = () => {
        carousalSlider.style.transform = "translateX(-300px)"
        
        btn5.disabled=false
        
    }
    const moveprev = () => {
        carousalSlider.style.transform = "translateX(0)"
        btn5.disabled=true
        btn4.disabled=false
    ...
    const Allcars = [
        {
            ...
            rate: '₹ 62,95,000',
            image: 'https://www.volvocars.com/images/cs/v3/assets/bltab26d231d43e6180/blt2c86d0477e9bb1a3/65719a324b2dba000d59e33e/c40-bev-my24-responsive.jpg?branch=prod_alias&auto=webp&h=500&iar=0',
        ...
        },
        {
            ...
            subtype: '',
            rate: '₹ 68,25,000',
            image: 'https://www.volvocars.com/images/cs/v3/assets/bltab26d231d43e6180/bltf7c2a2f9faf7c679/6583d71be209f3000db84700/s90-mhev-my24-responsive.jpg?branch=prod_alias&auto=webp&h=500&iar=0',
            subtext: 'Shop'
        }
            ...
            <div className='allcars'>
                <div className='d-flex justify-content-center align-items-center'>
                    ...
                    <div className='carousal' style={{  }} >
                        ...
                        <div id='carousalSlider' style={{ transition: "0.3s" }} className='d-flex'>

                            {Allcars.map((items, index) => (
                ...
                <div className='m-5 d-flex btndiv'>
                    <div className='btn5 m-1'> <button id='btn5' onClick={moveprev}  style={{ border: 'none' }}><KeyboardArrowLeftIcon  fontSize='medium' /></button></div>
                    <div className='btn5 m-1'> <button id='btn4' onClick={movenext} style={{ border: 'none' }}><KeyboardArrowRightIcon fontSize='medium' /></button></div>
